...
const createMap = (long, lat, zoom) => {
    ...
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/hawkinsohocl/ckd8k67i5098u1is2g8e3avln", 
...
const createApp = (map, csrf) => ({
    ...
    run() {
        ...
        this.map.on("load", () => {
            ...
            map.addSource("msoa", {
                "type": "vector",
                "url": "mapbox://hawkinsohocl.cpxwgnay" 
            });
            ...
            map.addLayer({
                ...
                "type": "fill",
                "source": "msoa",
                "source-layer": "msoa-2011-polygons-hcl-aseqrc",
                "paint": {
                    "fill-color": "#682f7f",
                    "fill-opacity": 0
                },
    ...
    return (properties) => {
        ...
        const html = `
            ...
            <div id="contentbox">
                ...
                <p>
                    <a href="/msoanames/static/MSOA-Names-1.3.0.xlsx">Excel</a> /
                    <a href="/msoanames/static/MSOA-Names-1.3.0.csv">CSV</a>
                </p>
            </div>
            <div id="buttonbox">
