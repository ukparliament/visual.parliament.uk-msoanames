...
const createMap = (long, lat, zoom) => {
    ...
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/hawkinsohocl/ckiaf5lyadepa19oypjl5vj32", 
...
const createApp = (map, csrf) => ({
    ...
    run() {
        ...
        this.map.on("load", () => {
            ...
            map.addSource("msoa", {
                "type": "vector",
                "url": "mapbox://hawkinsohocl.af8y7h2u" 
            });
            ...
            map.addLayer({
                ...
                "type": "fill",
                "source": "msoa",
                "source-layer": "msoa-2011-polygons-hcl-1ksh1w",
                "paint": {
                    "fill-color": "#682f7f",
                    "fill-opacity": 0
                },
    ...
    return (properties) => {
        ...
        const html = `
            ...
            <div id="contentbox">
                ...
                <p>
                    <a href="/msoanames/static/MSOA-Names-1.9.xlsx">Excel</a> /
                    <a href="/msoanames/static/MSOA-Names-1.9.csv">CSV</a>
                </p>
            </div>
            <div id="buttonbox">
