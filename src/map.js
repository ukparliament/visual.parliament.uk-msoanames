...
const createMap = (long, lat, zoom) => {
    ...
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/hawkinsohocl/ckhyzc0d91mg31bqu15nl3uq6", 
...
const createApp = (map, csrf) => ({
    ...
    run() {
        ...
        this.map.on("load", () => {
            ...
            map.addSource("msoa", {
                "type": "vector",
                "url": "mapbox://hawkinsohocl.1078h8wq" 
            });
            ...
            map.addLayer({
                ...
                "type": "fill",
                "source": "msoa",
                "source-layer": "msoa-2011-polygons-hcl-2nbka5",
                "paint": {
                    "fill-color": "#682f7f",
                    "fill-opacity": 0
                },
    ...
    return (properties) => {
        ...
        const html = `
            ...
            <div id="contentbox">
                ...
                <p>
                    <a href="/msoanames/static/MSOA-Names-1.8.xlsx">Excel</a> /
                    <a href="/msoanames/static/MSOA-Names-1.8.csv">CSV</a>
                </p>
            </div>
            <div id="buttonbox">
