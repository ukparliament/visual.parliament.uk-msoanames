...
const createMap = (long, lat, zoom) => {
    ...
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/hawkinsohocl/ck2bxr2rt06bl1ck30ose011r",
...
const createApp = (map, csrf) => ({
    ...
    run() {
        ...
        this.map.on("load", () => {
            ...
            map.addSource("msoa", {
                "type": "vector",
                "url": "mapbox://hawkinsohocl.cr196a8r"
            });
            ...
            map.addLayer({
                ...
                "type": "fill",
                "source": "msoa",
                "source-layer": "msoa-2011-polygons-hcl-ctuh3c",
                "paint": {
                    "fill-color": "#d83808",
                    "fill-opacity": 0
                },
    ...
    return (properties) => {
        ...
        const html = `
            ...
            <div id="contentbox">
                ...
                <p>
                    <a href="/msoanames/static/MSOA-Names-v1.0.0.xlsx">Excel</a> /
                    <a href="/msoanames/static/MSOA-Names-v1.0.0.csv">CSV</a>
                </p>
            </div>
            <div id="buttonbox">
