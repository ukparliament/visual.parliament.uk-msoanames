...
const createMap = (long, lat, zoom) => {
    ...
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/hawkinsohocl/ckjiufxrs00bw1ap27gc2fkcv", 
...
const createApp = (map, csrf) => ({
    ...
    run() {
        ...
        this.map.on("load", () => {
            ...
            map.addSource("msoa", {
                "type": "vector",
                "url": "mapbox://hawkinsohocl.8sw9gkft" 
            });
            ...
            map.addLayer({
                ...
                "type": "fill",
                "source": "msoa",
                "source-layer": "msoa-2011-polygons-hcl-aawz4i",
                "paint": {
                    "fill-color": "#682f7f",
                    "fill-opacity": 0
                },
    ...
    return (properties) => {
        ...
        const html = `
            ...
            <div id="contentbox">
                ...
                <p>
                    <a href="/msoanames/static/MSOA-Names-1.10.xlsx">Excel</a> /
                    <a href="/msoanames/static/MSOA-Names-1.10.csv">CSV</a>
                </p>
            </div>
            <div id="buttonbox">
